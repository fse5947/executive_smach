...
long_description = (
    ...
    "SMACH is a new library that takes advantage of very old concepts in order to quickly create "
    "robust robot behavior with maintainable and modular code.")
...
setup(
    ...
    description=
    'Task-level architecture for building hierarchical state machines.',
